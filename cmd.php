...
$start_allhost = "all-on";
$stop_allhost  = "all-off";
...
$check_blackList  = "ckbl";
$add_blacklist    = "adbl";
$remove_blacklist = "debl";

$check_ip   = "check-ip";
$check_user = "check-u";

$delete_message     = "demes";
$delete_message_all = "clear all";
...
$start_notify = "noti-on";
$stop_notify  = "noti-off";
